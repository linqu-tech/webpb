...
/**
 * Process the {@link WebpbMessageMapping} and transform it to Spring MessageMapping.
 */
@SupportedAnnotationTypes("tech.linqu.webpb.runtime.messaging.WebpbMessageMapping")
...
public class WebpbMessageMappingProcessor extends AbstractProcessor {
    ...
    private JCAnnotation transformAnnotation(JCCompilationUnit unit, JCMethodDecl method,
        ...
        String annotationName = WebpbMessageMapping.class.getSimpleName();
        ...
        return treeMaker
            .Annotation(treeMaker.Ident(names.fromString("MessageMapping")), List.from(args));
    }
