...
public class WebpbUtils {
    ...
    public static void updateAnnotation(Method method) {
        ...
        MessageMeta meta = Objects.requireNonNull(WebpbUtils.readMessageMeta(clazz),
     ...
     * @return MessageMeta
     */
    public static MessageMeta readMessageMeta(Class<?> type) {
        try {
            Field field = type.getDeclaredField("MESSAGE_META");
            return (MessageMeta) field.get(null);
